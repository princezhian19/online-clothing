...
$('#sendReview').click(function(){
    ...
    if(userName == '' || userMessage == ''){
        ...
        $.ajax({
            url:'classes/data-submit.php',
            method:'POST',
            data:{rating_value:rating_value, userName:userName, userMessage:userMessage, prod_id:prod_id, prod_slug:prod_slug},
